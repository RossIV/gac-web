    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <nav class="hidden md:flex space-x-10">
                @if(Auth::check())
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> My Team </a>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Registration </a>
                @if(Auth::user()->hasRole('game-control'))
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Admin </a>
                @endif
                @endif
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Main Site </a>
            </nav>
